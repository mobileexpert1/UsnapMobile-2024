...
class ImagePickerCollectionViewCell: UICollectionViewCell {
    ...
    fileprivate func loadPhotoAssetIfNeeded() {
        ...
        imageRequestID = manager.requestImage(for: asset, targetSize: PHImageManagerMaximumSize, contentMode: .aspectFill, options: options, resultHandler: { [weak self] (result, info) in
