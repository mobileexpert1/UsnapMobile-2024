...
class TermsAndConditionsViewController: AbstractControl, WKNavigationDelegate, WKUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        centeredNavBarImageView()
              ...
              let closeButtonImage = UIImage(named: "BackIcon")
                      navigationItem.leftBarButtonItem = UIBarButtonItem(image: closeButtonImage, style: .plain, target: self, action:  #selector(TermsAndConditionsViewController.barButtonDidTap(_:)))
