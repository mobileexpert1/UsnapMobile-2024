...
//        let testData = NSMutableDictionary()
//        testData[(kCGImagePropertyExifUserComment as String)] = uniqueImageId
//
//        mutableDict.setValue(testData, forKey: kCGImagePropertyExifDictionary as String)
        
        
        let testData = NSMutableDictionary()
        testData[(kCGImagePropertyTIFFOrientation as String)] = "Rotate 90 CW"
    ...
    func exposureStartCustom() {
        ...
        _showFocusRectangleAtPoint(self.lastFocusPoint!, inLayer: previewLayer!, withBrightness: exposureValue)
